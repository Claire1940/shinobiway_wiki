...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Shinobi Way Wiki',
    description: 'Copyright and intellectual property information for Shinobi Way Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Shinobi Way Wiki',
      description: 'Copyright and intellectual property information for Shinobi Way Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Shinobi Way Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Shinobi Way Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Shinobi Way Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Ouro Games</strong> - Creator community for the Shinobi Way Roblox game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Ouro Games</strong> - Creator community for Shinobi Way on Roblox</li>
              <li><strong>Shinobi Way</strong> - Trademark or game title of its respective owners</li>
              <li><strong>Shinobi Way Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Shinobi Way Wiki.
            </p>
            ...
            <p>
              ...
              Shinobi Way Wiki<br />
              Email: <a href="mailto:dmca@shinobiway.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@shinobiway.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Shinobi Way Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Shinobi Way Wiki (shinobiway.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@shinobiway.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@shinobiway.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@shinobiway.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@shinobiway.wiki</a>
            </p>
            <p>
