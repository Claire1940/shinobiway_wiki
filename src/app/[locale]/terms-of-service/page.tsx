...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Shinobi Way Wiki",
    description: "Read the Terms of Service for Shinobi Way Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Shinobi Way Wiki",
      description: "Terms and conditions for using Shinobi Way Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Shinobi Way Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Shinobi Way Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Shinobi Way Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Shinobi Way Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Shinobi Way". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Shinobi Way codes and reward tracking</li>
              <li>Lineage, jutsu, and stat progression guides</li>
              <li>Quest, mission, and daily objective help</li>
              <li>Beginner, build, and PvP strategy guides</li>
              <li>Community discussion and resource updates</li>
            </ul>
            <p>
              <strong>Important:</strong> Shinobi Way Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation, Ouro Games, or the official developers of Shinobi Way. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Shinobi Way Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation, Ouro Games, and/or the developers of Shinobi Way. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, SHINOBI WAY WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Shinobi Way Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@shinobiway.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@shinobiway.wiki</a>
            </p>
            <p>
